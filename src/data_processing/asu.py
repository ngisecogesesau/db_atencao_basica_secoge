...
def read_asu():
    ...
    # asu_classificacao
    url_asu_classificacao = '/Shared Documents/SESAU/BI_Indicadores_Estrategicos/tooltip_classificacao_asu.xlsx'
    ...
    # equipes_asu
    url_equipes_asu = '/Shared Documents/SESAU/BI_Indicadores_Estrategicos/asu_provisório.xlsx'
    ...
    url_unidades_equipes_asu = '/Shared Documents/SESAU/BI_Indicadores_Estrategicos/asu_provisório.xlsx'
